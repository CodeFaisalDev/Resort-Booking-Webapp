  ...
  try {
    ...
    const htmlBody = `
      <div style="font-family: Arial, sans-serif; background-color: #0c0a09; color: #f5f5f4; padding: 40px; border-radius: 16px; border: 1px solid #78350f; max-width: 500px; margin: 0 auto;">
        ...
        <p style="font-size: 14px; line-height: 1.6;">Thank you for registering at Luxury Horizon Resort. To activate your account, please enter the following verification code:</p>
    ...
    await sendMail({
      to: email,
      subject: "Email Verification Code - Luxury Horizon Resort",
      html: htmlBody
    });
